...
public class QuizListActivity extends AppCompatActivity implements AsyncResponse, AdapterView.OnItemClickListener {

    private ArrayList<QuizInfo> quizList;
    private ListView lvQuiz;
    TextView tvEmpty;
    String username;
    final String LOG = "QuizListActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PostResponseAsyncTask taskRead = new PostResponseAsyncTask(QuizListActivity.this, postData, this);
    ...
    public void processFinish(String s) {
        ...
        if(s.contains("<br />")){
            ...
            FunDapter<QuizInfo> adapter = new FunDapter<>(QuizListActivity.this, quizList, R.layout.layout_list, dict);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent = new Intent(QuizListActivity.this, MultipleChoice.class);
